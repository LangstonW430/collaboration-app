      ...
      <div data-testid="document-card" className="relative bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 hover:shadow-md transition-all cursor-pointer group h-full flex flex-col">
          ...
          <div className="absolute top-2.5 right-2.5 flex items-center gap-1" onClick={e => e.preventDefault()}>
            {confirming ? (
              ...
              <>
                ...
                <button onClick={handleDelete} className="p-1.5 rounded-md text-gray-300 hover:text-red-500 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-all" title="Delete document">
        ...
        {!isOwner && (
          <div className="absolute top-2.5 right-2.5">
            <span className="text-xs px-2 py-0.5 bg-blue-50 text-blue-600 rounded-full font-medium capitalize">{document.userRole}</span>
          </div>
        )}
